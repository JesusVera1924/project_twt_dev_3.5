...
Future<bool> showDialogDevDialogVen(
    BuildContext context, VendedorProvider provider, String titulo) async {
  List<String> _tipoValor =
      provider.isSelectAll ? ["Devolución"] : ["Devolución", "Garantía"];
  bool op = false;
  await showDialog(
              ...
              title: Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(titulo, style: CustomLabels.h5),
                  ),
                ],
              ),
              content: Container(
